...
######################
#creates a new movie Hash with director's name provided
...
def gross_per_studio(collection)
  ...
  #  worldwide_gross = collection[i][:worldwide_gross]
    if !new_hash[collection[i][:studio]] #if not exist
      new_hash[collection[i][:studio]] = collection[i][:worldwide_gross] #studio_name=>total_gross
    else
